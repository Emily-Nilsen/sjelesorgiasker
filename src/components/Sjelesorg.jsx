...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Kirken har alltid tilbudt sjelesorg som en del av sin tjeneste i møte med befolkningen. Våre sjelesørgere er enten prester med fast jobb i kirken, eller de er pensjonister eller andre som ønsker å gi noen timer hver uke som en frivillig tjeneste.',
  },
  {
    id: 10,
    question: 'Har sjelesørgeren taushetsplikt?',
    answer: `Ja, sjelesørgere har svært streng taushetsplikt. Du skal ikke være redd for at det du sier blir røpet for andre eller at sjelesørgeren forteller at du går i sjelesorg. Taushetsplikten må likevel vike for <a target='_blank' rel='noreferrer' style='color:#c026d3; font-weight:500; text-decoration:underline;' href='https://plikt.no/'> avvergeplikten</a> som er beskrevet i <a target='_blank' rel='noreferrer' style='color:#c026d3; font-weight:500; text-decoration:underline;' href='https://lovdata.no/dokument/NL/lov/2005-05-20-28/KAPITTEL_2-5#%C2%A7184'> straffelovens §196</a>. Alle mennesker har plikt til å forsøke å avverge vold eller seksualovergrep. Det gjelder også dem som har taushetsplikt. Dersom man får kunnskap om at en slik straffbar handling vil skje, eller tror at det er mest sannsynlig at handlingen vil skje, må man melde fra til politi eller barnevern.`,
  },
  {
    id: 11,
  ...
  },
  {
    ...
    answer:
      'Ta kontakt med oss gjennom kontaktskjemaet under. Din melding sendes til leder for Sjelesorg i Asker, sokneprest Astrid Sætrang Morvik som videresender din forespørsel til den sjelesørgeren du ønsker. Sjelesørgeren tar kontakt på telefon og gjør en avtale om tid og sted. Du kan regne med å få svar av din sjelesørger innen en uke.',
  },
]
...
export function Sjelesorg() {
  return (
    <section
      ...
      className="pt-20 pb-16 overflow-x-hidden sm:pb-20 md:pt-36 lg:py-32"
    >
      <Container>
        ...
        <div className="md:mx-none rounded-2xl bg-stone-50 sm:rounded-4xl md:-mx-20 md:rounded-6xl">
          <div className="px-4 py-12 mx-auto max-w-7xl sm:py-16 sm:px-12 lg:px-8">
            <div className="max-w-3xl mx-auto divide-y-2 divide-stone-200">
              <h2 className="text-4xl font-bold tracking-tight text-center font-display text-stone-900">
