const sjelesorgere = [
  ...
  },
  {
    ...
    profile: [
      ...
      'Hvis du har tanker om at du har en slags tro, søken eller lengsel, kan det være spennende å lete og utforske hvor Gud er i livet ditt. For jeg tror Gud møter oss på en måte som vi kan erfare, men ikke alltid forstå. Så enkelt og så vanskelig. Jeg kan bli med å lete sammen med deg.',
      'Av og til er livet lett, men ofte er det litt kronglete eller veldig vanskelig.',
      'Derfor vil jeg være tilgjengelig for samtaler for kirkene i Asker, om livet ditt er med eller uten en tro, og om alt livet byr på av svingete veier, omveier og tunge oppoverbakker.',
    ],
  },
  {
    name: 'Thomas Hauge',
